...
public class BiConsumerFunction {
    ...
    /**
     * *******IMPERATIVE LOGIC********* for (int i = 0; i <
     * coffeeRatings.size(); i++) { String coffee = (String)
     * coffeeRatings.keySet().toArray()[i]; Integer rating =
     * coffeeRatings.get(coffee); System.out.println("Coffee " + coffee + "
     * Rating " + rating); }
    *********************************
     */
}
